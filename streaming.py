...
# optiTrack.readSocket()
    ...
    # FrameOfData(frameno=146765, sets={b'all': []}, other_markers=[(0.09026086330413818, 0.2435210943222046, 0.015333890914916992), (0.08072531968355179, 0.002592326607555151, -0.06814895570278168), (0.07142879068851471, -0.2369968295097351, -0.15248703956604004)], rigid_bodies=[], skeletons=[], labeled_markers=[LabeledMarker(id=5028, position=(0.09026086330413818, 0.2435210943222046, 0.015333890914916992), size=0.011816475540399551, occluded=False, point_cloud_solved=True, model_solved=False), LabeledMarker(id=5029, position=(0.08072531968355179, 0.002592326607555151, -0.06814895570278168), size=0.012152580544352531, occluded=False, point_cloud_solved=True, model_solved=False), LabeledMarker(id=5030, position=(0.07142879068851471, -0.2369968295097351, -0.15248703956604004), size=0.013185441493988037, occluded=False, point_cloud_solved=True, model_solved=False)], latency=0.5968000292778015, timecode=(0, 0), timestamp=1223.0416666666667, is_recording=False, tracked_models_changed=False)
